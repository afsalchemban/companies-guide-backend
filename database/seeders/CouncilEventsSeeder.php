...
class CouncilEventsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        ('event', 'https://storage.googleapis.com/business-council-bucket/presentation/council_1/events/event_11/event/desktop/image.png', 'https://storage.googleapis.com/business-council-bucket/presentation/council_1/events/event_11/event/mobile/image.png', 'https://storage.googleapis.com/business-council-bucket/presentation/council_1/events/event_11/event/thumbnail/image.png', 5, 'councilEvent', NULL, NULL);
        ");
    }
}
