...
class CouncilMemberSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        ('Prof. Leo Vandervort', '2021-12-26', '1', 'qjohnston@example.org', NULL, '(380) 220-7314', 'Ut.', 'council/members/profile-images/no-image.png', 1, 1, 1, 1, '2022-05-09 15:39:38', '2022-05-09 15:39:38');");
    }
}
