    ...
    <tbody>
      ...
      <tr>
        <td style="vertical-align:top">
          <p style="margin:0 0 10px 0;padding:0;font-size:14px;"><span style="font-weight:bold;font-size:13px;">{{ $mailData['council_name'] }}</span></p>
      ...
      <tr>
       ...
       <tr>   
         <td>
          <p style="margin:0 0 10px 0;padding:0;font-size:14px;">Please find attached the detailed terms and conditions of the Business Councils Network platform (bcnid.com).</p>
