...
class ImageService
{
    ...
    public function updateCompanyProfilPageImages($company, $files)
    {
        ...
        foreach ($files as $file) {
            $image = new Image;
            $image->desktop_path = $this->_resizeImage(DefaultImageConstants::COMPANY_PROFILE_PAGE_IMAGE_DESKTOP_SIZE,$file,"companies/company_$company->id/profile-page-images/desktop");
            $image->mobile_path = $this->_resizeImage(DefaultImageConstants::COMPANY_PROFILE_PAGE_IMAGE_MOBILE_SIZE,$file,"companies/company_$company->id/profile-page-images/mobile");
            $image->thumbnail_path = $this->_resizeImage(DefaultImageConstants::COMPANY_PROFILE_PAGE_IMAGE_THUMBNAIL_SIZE,$file,"companies/company_$company->id/profile-page-images/thumbnail");
    ...
    {
        $image = new Image;
        $image->desktop_path = $this->_resizeImage(DefaultImageConstants::COMPANY_PRODUCT_DESKTOP_SIZE,$file,"companies/company_$company->id/products/product_$product->id/desktop");
        $image->mobile_path = $this->_resizeImage(DefaultImageConstants::COMPANY_PRODUCT_MOBILE_SIZE,$file,"companies/company_$company->id/products/product_$product->id/mobile");
        $image->thumbnail_path = $this->_resizeImage(DefaultImageConstants::COMPANY_PRODUCT_THUMBNAIL_SIZE,$file,"companies/company_$company->id/products/product_$product->id/thumbnail");
        $image->type = 'product';
